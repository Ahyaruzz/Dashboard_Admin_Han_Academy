...
<body class="bg-[#F4F5FF]">
    ...
    <x-sidebar></x-sidebar>
    <div class="xl:ml-80 mt-6 flex flex-wrap gap-6 justify-center overflow-x-auto px-4 pt-4">
        <!-- Total Member -->
        <div class="bg-white shadow-md rounded-lg p-6 flex items-center justify-between min-w-[200px] w-full sm:w-auto">
            <div class="bg-blackButton w-12 h-12 rounded-md flex items-center justify-center">
