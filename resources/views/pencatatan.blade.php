        ...
        <main class="flex-1 p-10">
            <form class="bg-white p-8 rounded-lg shadow-md space-y-6">
              ...
              <div>
                ...
                <select class="mt-1 w-full h-10 border text-secondary px-3 border-gray-400 rounded-md shadow-sm text-base focus:border-indigo-500 focus:ring-indigo-500">
              ...
              <div>
                <label class="block text-sm font-semibold text-black">No HP</label>
                <input type="text"  placeholder="Masukkan No.Hp..."  class="mt-1 w-full h-10 px-3 border border-gray-400 rounded-md shadow-sm text-base focus:border-indigo-500 focus:ring-indigo-500">
              </div>
          
              <div>
                <label class="block text-sm font-semibold text-black">Jenis Beladiri</label>
                <select class="mt-1 w-full h-10 border text-secondary px-3 border-gray-400 rounded-md shadow-sm text-base focus:border-indigo-500 focus:ring-indigo-500">
              ...
              <div>
                <label class="block text-sm font-semibold text-black">Sabuk</label>
                <select class="mt-1 w-full h-10 border text-secondary px-3 border-gray-400 rounded-md shadow-sm text-base focus:border-indigo-500 focus:ring-indigo-500">
              ...
              <div>
                <label class="block text-sm font-semibold text-black">Membership</label>
                <select class="mt-1 w-full h-10 border text-secondary px-3 border-gray-400 rounded-md shadow-sm text-base focus:border-indigo-500 focus:ring-indigo-500">
              ...
              <div>
                <label class="block text-sm font-medium text-black">Coach</label>
                <select class="mt-1 w-full h-10 border text-secondary px-3 border-gray-400 rounded-md shadow-sm text-base focus:border-indigo-500 focus:ring-indigo-500">
              ...
              <div class="justify-items-center">
                <button type="submit" class=" justify-center  bg-primary hover:bg-red-600 text-white py-2 px-4 rounded-md">
                    Simpan
                </button>
              </div>
            </form>
