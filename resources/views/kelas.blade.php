...
<body class="bg-[#F4F5FF]">
    ...
    <x-sidebar></x-sidebar>
    <div class=" mt-5 xl:ml-80 xl:mt-10 xl:grid xl:grid-cols-3">
        {{-- card 1 --}}
        <div class="rounded-lg mt-4 ml-6 mr-6 xl:ml-0 w-auto h-auto bg-white xl:h-36 xl:rounded-2xl">
            <div class="flex py-4 pl-4">
                ...
                <div class="ml-4">
                    <p class="font-bold text-sm">Brazilian Jiu Jitsu</p>
                    <p class="text-xs text-secondary mt-2">Coach Brian</p>
                </div>
            </div>
            ...
            <div class="ml-4 my-4 pb-4 flex items-center gap-2">
                ...
                <p class="text-xs font-semibold">2 Member</p>
            </div>
        </div>
        {{-- card 2 --}}
        <div class="rounded-lg mt-4 ml-6 mr-6 xl:ml-0 w-auto h-auto bg-white xl:h-36 xl:rounded-2xl">
            <div class="flex py-4 pl-4">
                <img class="" src="{{ asset('img/kelas.png') }}" alt="Logo"/> 
                <div class="ml-4">
                    <p class="font-bold text-sm">Kick Boxing</p>
        ...
        <div class="rounded-lg mt-4 ml-6 mr-6 xl:ml-0  w-auto h-auto bg-white xl:h-36 xl:rounded-2xl">
            <div class="flex py-4 pl-4">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-xs text-secondary mt-2">Coach Agung</p>
                </div>
            </div>
            <hr class="border-gray-200">
            <div class="ml-4 my-4 pb-4 flex items-center gap-2">
        ...
        <div class="rounded-lg mt-4 ml-6 mr-6 xl:ml-0  w-auto h-auto bg-white xl:h-36 xl:rounded-2xl">
            <div class="flex py-4 pl-4">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-xs text-secondary mt-2">Coach Josh</p>
                </div>
            </div>
            <hr class="border-gray-200">
            <div class="ml-4 my-4 pb-4 flex items-center gap-2">
        ...
        <div class="rounded-lg mt-4 ml-6 mr-6 xl:ml-0  w-auto h-auto bg-white xl:h-36 xl:rounded-2xl">
            <div class="flex py-4 pl-4">
                <img class="" src="{{ asset('img/kelas.png') }}" alt="Logo"/> 
                <div class="ml-4">
                    <p class="font-bold text-sm">Private Class</p>
                    <p class="text-xs text-secondary mt-2">Coach Brian</p>
                </div>
            </div>
            <hr class="border-gray-200">
